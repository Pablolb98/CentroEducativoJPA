...
public ValoracionMateria findEstudianteProfesorMateria (Profesor profesor, Materia materia, Estudiante estudiante) {
...
public ValoracionMateria findEstudianteProfesorValoracionMateria (Profesor profesor, Materia materia, Estudiante estudiante, Float nota) {
	ValoracionMateria resultado = null;
	EntityManager em = factory.createEntityManager();
